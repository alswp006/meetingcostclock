...
- schema.ts: export function isMeetingSetupInput(v: unknown): v is MeetingSetupInput; export function isMeetingSetup(v: unknown): v is MeetingSetup; expo...
...
- 0014: S5 리포트 페이지 (/report/:id: 보상형 광고 게이트, 낭비 분석, 액션) (files: src/components/report/ReportBody.tsx, src/pages/Report.tsx, src/pages/__tests__/Report.test.tsx)
- 0015: S1 홈 대시보드 (/: 진행 중 카드, 이번 주 합계, 최근 회의) (files: src/pages/Home.tsx, src/pages/__tests__/Home.test.tsx)
- 0016: [부가] S6 공유 카드 페이지 (/report/:id/card: 광고 게이트, 이미지 저장, 텍스트 공유) (files: src/components/card/CardActions.tsx, src/pages/Card.tsx, src/pages/__tests__/Card.test.tsx)
...
// src/components/history/TeamRanking.tsx
...
// src/components/report/ReportBody.tsx
