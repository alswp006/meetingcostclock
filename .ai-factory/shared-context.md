...
- schema.ts: export function isMeetingSetupInput(v: unknown): v is MeetingSetupInput; export function isMeetingSetup(v: unknown): v is MeetingSetup; export function isActiveMeeting(v: unknown): v is ActiveMeeting; ex...
